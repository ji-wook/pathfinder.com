...
<body>
    <h1 id="h1">Search Job Here</h1>
    <form action="s_search_result.php" method="POST">
    <div class="card">
        <p class="title">Job Title:</p>
        <select name="search_job_job_title" id="job">
            ...
            <select name="search_job_location" id="location">
             ...
             <button id="search-btn" name="search_job-btn" type="submit" class="search-btn">Search</button>
        </div>
        </form>
